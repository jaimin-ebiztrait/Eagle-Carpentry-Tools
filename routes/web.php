...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    // Route::post('/delete-CMS-page', [AdminCmsController::class, 'delPage'])->name('admin.delete_cms_page');
     ...
     Route::get('/list-products', [ProductController::class, 'index'])->name('admin.list_product');
    ...
    Route::post('/update-product/{id}', [ProductController::class, 'update'])->name('admin.update_product');
    Route::post('/delete-product/{id}', [ProductController::class, 'destroy'])->name('admin.delete_product');
 Route::get('/product/image/delete/{id}', [ProductController::class, 'deleteImage'])
        ->name('admin.delete_product_image');
    // Ratings
