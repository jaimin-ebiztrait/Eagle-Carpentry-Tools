...
<body>
    ...
    <header>
        <div class="wrapper">
            <div class="header_top">
                <div class="logo">
                    <a href="{{ url('/') }}"><img src="{{ asset('frontend/images/logo.png') }}" alt="logo" title="logo"></a>
                </div>
    ...
    <!-- Content Section -->
    <div class="container">
        @yield('content') <!-- This will be replaced by specific page content -->
    </div>
    ...
    <footer>
        <div class="wrapper">
            <div class="foot_left">
                ...
                <p>Ph.+91-281-2457387, Fax.+91-281-2458479, Email: <a href="mailto:info@eaglecarpentrytools.com">info@eaglecarpentrytools.com</a></p>
    ...
    <li><a href="{{ route('contact') }}">Contact</a></li>
            ...
            <div class="foot_right">
                <p>2015 © eBizTrait. ALL Rights Reserved.</p>
